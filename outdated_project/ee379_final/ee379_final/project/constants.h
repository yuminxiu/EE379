...
#define ALIEN_ROWS 3
#define ALIEN_COLS 6
#define ALIEN_SPACING_Y 5 // placeholder
#define ALIEN_SPACING_X 5 // placeholder
#define MAX_ALIENS (ALIEN_ROWS * ALIEN_COLS)

#define ALIEN_MOVE_SPEED 3 //placeholder value
...
#define BOSS_SPEED 2 // placeholder
...
#define ENEMY_BULLET_SPEED 5 //placeholder
...
#define POWERUP_SPEED 4 // placeholder
...
#define SCORE_MULT_TIME   120
#define LASER_TIME        120
#define SHIELD_TIME       300
#define TRIPLE_SHOT_TIME  60
...
#define BEAM_WARNING_TIME 20 //place holder
#define BEAM_FIRE_TIME 15 //place holder

//Spawning

#define SHIP_SPAWN_MIN_SEC       5
#define SHIP_SPAWN_RANGE_SEC     1

#define POWERUP_SPAWN_MIN_SEC    1
#define POWERUP_SPAWN_RANGE_SEC  2
